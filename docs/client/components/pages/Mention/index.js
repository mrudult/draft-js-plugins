    ...
    return (
      <div>
        ...
        <Container>
          ...
          <p>
            Mentions for everyone! This plugin allows the user to choose an
            entry from a list. After selection an entry the search text will be
            replace with the selected entity. The list of suggestions mentions
            needs to contain at least a name to display. If desired a link
            and/or an avatar image can be provided.
          </p>
          ...
          <p>
            ...
            suggestions will appear again once the user selects the word that
        ...
        <Container>
          ...
          <div className={styles.param}>
            ...
            <span>
              ...
              and props. An object should be returned which can contain all
              sorts of styles. The defined properties will be applied as
              inline-styles.
            </span>
          </div>
          <div className={styles.param}>
          ...
          <div className={styles.param}>
            ...
            <span>
              By default it is an empty String. For Twitter or Slack like
              mention behaviour you can provide an `@`
            </span>
          </div>
          <div className={styles.param}>
          ...
          <div className={styles.param}>
            ...
            <span>
              ...
              will trigger the search for mentions. Note: the implementation
              does not support a multi-character mentionTrigger.
            </span>
          </div>
          <div className={styles.param}>
          ...
          <div className={styles.param}>
            ...
            <span>
              ...
              useful for searching first and last names. By default this is set
              to `false`
            </span>
          </div>
          <div className={styles.param}>
          ...
          <div>
            ...
            <div className={styles.param}>
              ...
              <span>
                A callback which is triggered whenever the mention is about to
                be added. The first argument of this callback will contain the
                mention entry.
              </span>
            </div>
            <div className={styles.param}>
        ...
        <Container>
          ...
          <Code
            ...
            name="CustomComponentMentionEditor.js"
          />
          <Code
